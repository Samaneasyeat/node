      ...
      <div className="container" style={myStyle}>
        ...
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                custom CSS or overriding our default variables. It also worth
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                this with custom CSS or overriding our default variables. It
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                <strong>This is the third item accordion body.</strong> It is
                hidden by default, until the collapse plugin adds the
                appropriate classNames that we use to style each element. These
                classNames control the overall appearance, as well as the
                showing and hiding via CSS transitions. You can modify any of
          ...
          <div className="btn-container mt-4">
            <button className="btn btn-warning mb-2" onClick={toggleStyle}>
              {btntext}
            </button>
          </div>
        </div>
